...
function [accel,gyro,time,tmp] = frameProcess(frame)
    ...
    if rem(sum(frame(1:18)),256)==frame(19)
        ...
        accel(1,1) = byte2double(frame(1),frame(2))/16384*9.7883; % +-2g
        accel(1,2) = byte2double(frame(3),frame(4))/16384*9.7883;
        accel(1,3) = byte2double(frame(5),frame(6))/16384*9.7883;
